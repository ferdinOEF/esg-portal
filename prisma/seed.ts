  ...
  const schemes = [
    {
      ...
      deadlines:
        "Aligned with financial year annual report timelines as per SEBI circulars.",
      features: [
    ...
    },
    {
      ...
      eligibility:
        "MSMEs registered on Udyam; additional conditions as per state/implementing guidelines.",
      process:
      ...
      benefits:
        "Improved market access, digital presence, brand readiness, potential sales growth.",
      deadlines:
        "As per current RAMP/TEAM programme window; check active state/PIA notifications.",
      features: [
    ...
    },
    {
      ...
      deadlines:
        "Transitional phase reporting began Oct 2023; full implementation phases continue per EU regulations.",
      features: [
